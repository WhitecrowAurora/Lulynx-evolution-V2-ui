...
import {
  ...
  KREA2_LORA_SECTIONS, KREA2_FT_SECTIONS, FLUX2_LORA_SECTIONS, ZIMAGE_LORA_SECTIONS, WAN22_TI2V_LORA_SECTIONS, WAN22_T2V_A14B_LORA_SECTIONS, LTX23_LORA_SECTIONS, BOOGU_LORA_SECTIONS, BOOGU_EDIT_LORA_SECTIONS, BOOGU_FT_SECTIONS, LTX23_FT_SECTIONS, FLUX2_FT_SECTIONS, ZIMAGE_FT_SECTIONS, WAN22_FT_SECTIONS,
...
export function getSectionsForType(typeId) {
  ...
  if (!_profiledSectionsCache[typeId]) _profiledSectionsCache[typeId] = [TRAINING_INTENT_PROFILE_SECTION, UNIVERSAL_DIT_SECTION, ...base];
