    ...
    <div className="lx-generate">
      <header className="lx-generate__head">
        ...
        <div className="lx-generate__actions">
          <button type="button" className="lx-btn lx-btn--primary" disabled={running} onClick={() => void start()}>
            {running ? t('generate.running') : t('generate.start')}
          </button>
          <button type="button" className="lx-btn" disabled={!running} onClick={() => void stop()}>
            {t('generate.stop')}
          </button>
        </div>
      </header>
      ...
      <div className="lx-generate__body">
        ...
        <section className="lx-generate__panel lx-generate__panel--wide">
